  ...
  <body>
    ...
    <h2 class="header"> TASC Office Administrator (UMAK)</h3> <br>
      ...
      <div style="overflow-x:auto;">
        ...
        <a href="verified.php" class="add"></i><span>Verified</span><i class='fas fa-arrow-right' style='font-size:16px;'> </a>
        <table>
          <tr>
          ...
          <?php
                      while($admin=mysqli_fetch_assoc($records)) {
                          ...
                          echo "
                            ...
                            ";
                            echo"
                            <td><a href  ='authorize.php?rn=$admin[id]&id=$admin[admin_id]&fn=$admin[fullname]&bd=$admin[birthdate]&con=$admin[contact]&em=$admin[email]'class='edit' > Authorize</a></td>                
                            </tr>
                            ";
                           }
