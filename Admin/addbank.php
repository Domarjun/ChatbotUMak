...
<body>
  ...
  <div class="container">
    <form action="" method="post">
      <h1 style="text-align: center;">Add Words</h1><br>
      
      <input type="hidden" name="id" value="<?php echo $id; ?>">
      <div class="row">
        <div class="col-25">
          <label for="lname">Word Collection</label>
        </div>
        <div class="col-75">
          <input type="text" name="fullname" value="<?php echo $fullname; ?>" placeholder="Input Words">
        </div>
      </div>
      <div class="row">
        <div class="col-25">
        ...
        <div class="col-75">
          <input type="text" name="birthdate" value="<?php echo $birthdate; ?>" placeholder="Input Answer">
        </div>
      </div>
